...
#The boot.py file is the first script that runs in the device when it is powered on. 
#It could be used for setting up a WiFi connection and thus declutter the main file where this code otherwise would be placed. 
#Most often you don't have to worry about this file.
